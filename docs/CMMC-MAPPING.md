...
**Emma Security Engineer** provides comprehensive coverage of CMMC (Cybersecurity Maturity Model Certification) Level 2 requirements for code-level security analysis.
...
CMMC Level 2 is based on NIST SP 800-171 and requires organizations to document and implement cybersecurity practices to protect Controlled Unclassified Information (CUI). Emma maps code-level vulnerabilities to CMMC practices, enabling:
...
**Note**: This domain covers organizational assessment programs and is not directly detectable at the code level. However, Emma's vulnerability scanning contributes to security assessment activities.
...
## Using Emma for CMMC Compliance
...
Add Emma to your CI/CD pipeline to enforce CMMC compliance:
